    ...
    public void getLongNameBun() {
        Mockito.when(bun.getName()).thenReturn(
                "QWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKL" +
                        "ZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYU" +
                        "IOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXC" +
                        "VBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOP" +
                        "ASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVB" +
                        "NMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASD" +
                        "FGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQ" +
                        "WERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFG" +
                        "HJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWE" +
                        "RTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJK" +
                        "LZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTY" +
                        "UIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZ" +
                        "XCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUI" +
                        "OASDFGHJKLZXCVBNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCV" +
                        "BNMQWERTYUIOPASDFGHJKLZXCVBNMQWERTYUIOASDFGHJKLZXCVBNMQWERTYUIOPA" +
