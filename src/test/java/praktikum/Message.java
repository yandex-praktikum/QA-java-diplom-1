...
public class Message {
    public static final String WRONG_NAME_MSG = "this name is wrong";
    public static final String WRONG_PRICE_MSG = "this price is wrong";
    public static final String WRONG_TYPE_MSG = "this type is wrong";
    public static final String WRONG_COUNT_ING_MSG = "wrong count ingredients";
