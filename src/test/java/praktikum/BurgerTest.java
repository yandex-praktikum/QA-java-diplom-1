...
public class BurgerTest {
    ...
    public void addIngredientTest() {
        ingredient1 = new Ingredient(IngredientType.SAUCE, "testPrice", 15F);
        Burger burger = new Burger();
    ...
    public void removeIngredientPositiveTest() {
        ingredient1 = new Ingredient(IngredientType.FILLING, "testPrice", 15F);
        Burger burger = new Burger();
    ...
    public void moveIngredientTest() {
        ingredient1 = new Ingredient(IngredientType.SAUCE, "testPrice1", 15F);
        ingredient2 = new Ingredient(IngredientType.FILLING, "testPrice2", 16F);
        Burger burger = new Burger();
        burger.ingredients.add(0, ingredient1);
    ...
    public void getReceiptTest() {
        ...
        when(burger.getPrice()).thenReturn(floatValue);
