...
public class BurgerTest {
    ...
    public void testGetReceipt() {
        ...
        String priceString = String.format("%.6f", price);
        String priceString2 = String.format("%,6f", price);
        assertEquals(expectedReceipt(priceString), burger.getReceipt());
        assertEquals(expectedReceipt(priceString2), burger.getReceipt());
    }
    ...
    public void testRemoveIngredient() {
        ...
        expectedIngredients.add(ingredientCutlet);
        assertEquals(expectedIngredients, burger.ingredients);
    }

    public String expectedReceipt(String priceString){
