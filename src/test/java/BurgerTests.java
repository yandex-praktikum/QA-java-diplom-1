...
public class BurgerTests {
    ...
    public void addIngredient() {
        ...
        assertEquals("Неверное количество ингредиентов", 1, burger.ingredients.size());
    }
    ...
    public void removeIngredient() {
        ...
        assertEquals("Неверное количество ингредиентов", 0, burger.ingredients.size());
    }
    ...
    public void moveIngredient() {
        ...
        assertEquals("Ингредиенты не поменяли свои индексы", firstIngredientInBurger, burger.ingredients.get(1));
    }
