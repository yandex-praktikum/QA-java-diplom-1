...
public class BurgerTest {
    ...
    public void checkAddIngredient() {
        ...
        assertTrue("Кол-во ингридиентов должно быть > 0", actual);

    }

    @Test
    public void checkGetValidPrice() {
        Mockito.when(mockBun.getPrice()).thenReturn(123.4f);
        burger.setBuns(mockBun);
        Float actual = burger.getPrice();
        Float expected = 246.8f;
        assertEquals("Цена должна быть",expected,actual,0.01f);
    }
    ...
    public void checkBunsSet() {
        ...
        assertTrue("Кол-во булочек должно быть > 0", actual);
    }
